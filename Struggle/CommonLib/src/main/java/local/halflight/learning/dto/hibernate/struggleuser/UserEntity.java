...
import local.halflight.learning.testutils.TestDataSource.User;
...
//for testing
	...
	public static StruggleUser getDto(UserEntity entity)
	{
		StruggleUser user = new StruggleUser();
		user.setPassword(entity.getPassword().toString());
		user.setUsername(entity.getUsername());
		user.setUserUUID(entity.getUserUUID());
		user.setProfile(ProfileEntity.getDto(entity.getProfile()));
		user.setRoles(RoleEntity.getDtoSet(entity.getRoles()));
		user.setSettings(SettingEntity.getDtoSet(entity.getSettings()));
